// courtesy https://gist.github.com/alojzije/11127839

(function($) {
    var $svgContainer= $("#timeline-svg-container");
    ...
    function connectElements(startElem, endElem) {
        reset(true);
        ...
        $svgContainer.addClass("is-active");

        $(window).one("resize", reset);
    }

    function reset(now) {
        $svgContainer.removeClass('is-active');
